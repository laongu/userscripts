...
// @match           https://metruyencv.info/truyen/*
...
(function ($, window, document) {
    ...
    var pageName = document.title,
        $download = $('<a></a>', {
            href: '#download',
            style: 'background-color:lightblue; padding: 5px; margin: 20px; display: block;',
            text: 'Tải xuống',
        }),
        status,
    ...
    window.addEventListener('load', function() {
        // Tự động kích vào phần tử <a> có data-toggle="modal" và các class text-primary, d-inline-flex, align-items-center
        var modalLink = document.querySelector('a[data-toggle="modal"].text-primary.d-inline-flex.align-items-center');
        if (modalLink) {
            modalLink.click();
        }
    });
